...
var base_url="<?php echo base_url();?>";
	function export_material_summary()
	{
		...
		jQuery.ajax({
			type: "POST",
			url: base_url+"reports/export_material_summary_all",
			data: report,
				...
				<div class="span12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<input name="submit" value="Export" onclick="export_material_summary();" id="submit" class="btn btn-primary" type="button">
