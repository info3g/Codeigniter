...
var base_url="<?php echo base_url();?>";
	function material_cond_summary()
	{
		...
		var report = { 'client_id' : client_id, 'building_id' : building_id, 'report_type' : report_type, 'good' : good, 'poor' : poor,'fair' : fair,'debris' : debris }
		jQuery.ajax({
			type: "POST",
			url: base_url+"reports/export_building_summary_all",
			data: report,
