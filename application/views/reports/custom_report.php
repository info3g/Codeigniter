<script>
	...
	function export_custom_summary()
	{
		...
		if( building !="Please Select" && system !="Please Select" && material !="Please Select" && material_identi !="Please Select" && friability !="-Please Select-" && access !="-Please Select-" && hazard !="-Please Select-" && action !="-Please Select-" )
		{
	...
	jQuery(document).ready(function(){
		...
		jQuery('#access').on('change',function(){
			...
			if( access != "-Please Select-" )
			{
				jQuery.ajax({
					type: "POST",
					url: base_url+"reports/get_hazard",
					data: data,
					success: function(data){
						console.log(data);	
		...
		jQuery('#hazard').on('change',function(){
			...
			if( access != "-Please Select-" )
			{
				jQuery.ajax({
					type: "POST",
					url: base_url+"reports/get_action",
					data: data,
					success: function(data){
						console.log(data);	
						...
						<div class="widget-content">
							...
							<?php //echo form_open('reports/export_custom_summary_all'); ?>
								...
								<div class="control-group">														
									...
									<div class="controls">
										<select name="action" id="action" class="span5">
										</select>
									</div>								
								</div>
