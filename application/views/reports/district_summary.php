...
var base_url="<?php echo base_url();?>";
	...
	function export_district_summary()
	{
		...
		if( district_id != "Please Select" )
		{
			...
			if( jQuery('#building_id :selected ').size() != '0')
			{
				var report = { 'client_id' : client_id, 'building_id' : building_id, 'report_type' : report_type, 'district_id' : district_id }
			}else{
				var report = { 'client_id' : client_id, 'building_id' : intValArray, 'report_type' : report_type, 'district_id' : district_id }
			}
			
			
			jQuery.ajax({
				type: "POST",
				url: base_url+"reports/export_district_summary_all",
				data: report,
				success: function(data){
				...
				<div class="span12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<input name="submit" value="Export" onclick="export_district_summary();" id="submit" class="btn btn-primary" type="button">
