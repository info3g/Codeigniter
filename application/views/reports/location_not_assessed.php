...
var base_url="<?php echo base_url();?>";
	function export_lns_summary()
	{
		...
		jQuery.ajax({
			type: "POST",
			url: base_url+"reports/export_location_not_surveyed",
			data: report,
				...
				<div class="span12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<input name="submit" value="Export" onclick="export_lns_summary();" id="submit" class="btn btn-primary" type="button">
