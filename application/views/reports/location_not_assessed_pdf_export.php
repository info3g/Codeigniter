...
<body style="background-color:#fff !important;font-family: 'Open Sans', sans-serif;color: #333333;">
					<?php $CI =& get_instance();?>
					<h3 style="text-align:center;font-size: 18px;line-height: 27px;">Location Not Assessed Report</h3>
						...
						<table>
							<tr>
								...
								<table class="table table-striped table-bordered bot_mar"  style="border:1px solid #333;margin-bottom: 0 !important;width: 100%;background-color: #fff;">
									<thead>
										<tr>
											<th style="background:#1398DA !important;color:#fff !important;font-size:14px !important;" class="span1"> Location Not Assessed </th>
											<th style="background:#1398DA !important;color:#fff !important;font-size:14px !important;" class="span1"> Location Not Surveyed </th>
										</tr>
									</thead>
									
									
									<tbody>	
										<?php $CI->list_location_not_surveyed( $building_id );?>
									</tbody>
								</table>
								</div>	
