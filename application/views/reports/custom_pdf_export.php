...
<body style="background-color:#fff !important;font-family: 'Open Sans', sans-serif;color: #333333;">
					<?php $CI =& get_instance();?>
					<h3 style="text-align:center;font-size: 18px;line-height: 27px;">Custom Summary Report</h3>
								...
								<table class="table table-striped table-bordered bot_mar"  style="border:1px solid #333;margin-bottom: 0 !important;width: 100%;background-color: #fff;">
									<thead>
										<tr>
											...
											<th style="background:#1398DA !important;color:#fff !important;font-size:14px !important;" rowspan="2" class="span1" width="400"> Locations </th>
									...
									<tbody>	
										<?php
										$CI->list_custom_summry( $building_id, $system, $material, $material_identi, $friability, $access, $hazard, $action );
										?>
									</tbody>
								</table>
								</div>	
