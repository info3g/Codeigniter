...
<body style="background-color:#fff !important;font-family: 'Open Sans', sans-serif;color: #333333;">
					<?php $CI =& get_instance();?>
					<h3 style="text-align:center;font-size: 18px;line-height: 27px;">Development Summary Report</h3>
						...
						<table>
							<tr>
								...
								<table class="table table-striped table-bordered bot_mar"  style="border:1px solid #333;margin-bottom: 0 !important;width: 100%;background-color: #fff;">
									...
									<tbody>	
										<?php /*$CI->list_development_summry( $building_id, $development );*/?>
										<?php $CI->list_development_summry( $building_id );?>
									</tbody>
								</table>
								</div>	
