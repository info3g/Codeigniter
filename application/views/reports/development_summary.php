...
var base_url="<?php echo base_url();?>";
	function export_dev_summary()
	{
		...
		jQuery.ajax({
			type: "POST",
			url: base_url+"reports/export_dev_summary_all",
			data: report,
				...
				<div class="span12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<?php //echo form_open('reports/export_material_summary_all'); ?>
							...
							<input name="submit" value="Export" onclick="export_dev_summary();" id="submit" class="btn btn-primary" type="button">
