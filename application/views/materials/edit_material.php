				...
				<div class="span12">
					...
					<div class="widget">
						...
						<div class="widget-content">
							...
							<?php 
							echo form_open('dashboard/edit_material/'.$bid.'/'.$material_values->id); ?>
							
								<div class="control-group">	
									<label class="control-label" for="siteFooter">Material Name*</label>
									<div class="controls">
										<input type="text" name="material_name" value="<?php echo $material_values->material_name;?>" id="material_name" class="span5" >
									</div>
								</div>
								...
								<div class="control-group">	
									...
									<div class="controls">
										<textarea name="material_desc" id="material_desc" class="span5" ><?php echo $material_values->material_desc;?></textarea>
									</div>
								</div>
							<hr>
